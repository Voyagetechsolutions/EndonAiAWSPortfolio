"""Render Kubernetes scan results for humans and the CI gate."""
...
def render_console(result: GateResult) -> str:
    lines = ["ENDON AI - KUBERNETES SECURITY SCAN", "=" * 35, ""]
    ...
    for finding in result.findings:
        ...
        lines.append(f"{mark} [{finding.severity.value:<8}] {finding.control_id:<12} {target}")
