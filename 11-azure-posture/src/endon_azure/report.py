"""Render Azure scan results for humans and the CI gate."""
...
def render_console(result: GateResult) -> str:
    lines = ["ENDON AI - AZURE POSTURE SCAN", "=" * 29, ""]
    ...
    for finding in result.findings:
        ...
        short = target.rsplit("/", 1)[-1] if target else "-"
        lines.append(f"{mark} [{finding.severity.value:<8}] {finding.control_id:<11} {short}")
