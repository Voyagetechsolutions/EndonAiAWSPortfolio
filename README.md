...
> **Status:** the shared platform, **Project 1 (Threat Detection & Response)** and
> **Project 2 (IAM Analyzer)** are built, tested and deployable. The remaining components
> are designed and are being built in order. Each component's README states exactly what
> exists today.
