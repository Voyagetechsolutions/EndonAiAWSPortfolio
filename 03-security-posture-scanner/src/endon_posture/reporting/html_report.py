"""Self-contained HTML posture report, suitable for evidence."""
...
<title>Endon AI - Cloud Security Posture</title>
<style>
...
<body>
<header>
  <h1>Endon AI &middot; Cloud Security Posture</h1>
...
<div class="wrap">
  <div class="summary">
    <div class="score">{score}<span style="font-size:15px;color:#4a5568">/100</span>
      <div style="font-size:13px;color:#4a5568;font-weight:400">Posture score</div></div>
    <div class="cards">{cards}</div>
  </div>
  <div class="scanned">Services scanned: {services}</div>
  <table>
